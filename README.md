...
<main>
  ...
  <section id="about" class="page" style="display:none;">
    <h2>About Us</h2>
    <p>Anoop Marskole Job Portal is dedicated to connecting job seekers with employers across India.</p>
  </section>
  ...
  <section id="blog" class="page" style="display:none;">
    <h2>Blog</h2>
    <article>
      <h3>How to Prepare for Interviews</h3>
      <p>Interview preparation tips and tricks.</p>
    </article>
    <article>
      <h3>Top 10 Skills in Demand</h3>
      <p>Learn about the hottest skills in the job market.</p>
    </article>
  </section>
  ...
  <section id="contact" class="page" style="display:none;">
    ...
    <p id="formMsg"></p>
    <br />
    <a href="https://wa.me/1234567890" target="_blank" style="color:#007BFF; font-weight:bold;">Chat with us on WhatsApp</a>
  </section>
